package com.CodeKanic.ckutilities.common.capabilities;
...
public class EnergyStorageItemstack extends EnergyStorage {
    ...
    public EnergyStorageItemstack(int capacity, ItemStack itemStack) {
        ...
        this.energy = itemStack.getOrDefault(CKUDataComponents.ENERGY_STORAGE, 0);
    }

    public void setEnergy(int energy) {
        this.energy = energy;
        itemStack.set(CKUDataComponents.ENERGY_STORAGE, energy);
    }
    ...
    public int getEnergyStored() {
        return itemStack.getOrDefault(CKUDataComponents.ENERGY_STORAGE, 0);
    }
